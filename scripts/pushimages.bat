...
:DEFAULT_REGISTRY
    SET REGISTRY_URL=046222885654.dkr.ecr.eu-central-1.amazonaws.com
    SET REGISTRY_NAMESPACE=konveyor
	GOTO DOCKER_CONTAINER_RUNTIME
...
echo "pushing image postgres-demo"
%CONTAINER_RUNTIME% tag postgres-demo %REGISTRY_URL%/%REGISTRY_NAMESPACE%/postgres-demo
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/postgres-demo
